...
const messages = {
  en: {
    ...
    'cli.init.selectTools': 'Select AI tools to connect:',
    'cli.init.selectSpecTools': 'Select spec tools to connect:',
  ...
  'zh-TW': {
    ...
    'cli.init.selectTools': '選擇要連結的 AI 工具：',
    'cli.init.selectSpecTools': '選擇要連結的規格工具：',
